...
public class CraftMenu {
	...
	public static PlaceType ChooseType(int choice, PlaceType pT, Scanner sc) {
		switch (choice) {
		case 1:
			System.out.println("Irmãos Selecionado!");
			pT = PlaceType.CAPITULO;
			break;
		case 2:
			System.out.println("Primas Selecionado!");
			pT = PlaceType.BETHEL;
			break;
		case 3:
			System.out.println("Tios Selecionado!");
			pT = PlaceType.LOJA;
			break;
		case 4:
			System.out.println("Pessoa Comum Selecionado!");
			pT = PlaceType.PESSOA;
			break;
		case 5:
	...
	public static String ChangeTo(int choice, Scanner sc) {
		...
		case 4:
			...
			return word;
		case 5:
			System.out.println("Entre com o novo Assunto");
			word = sc.nextLine();
			return word;
		case 6:
			System.out.println("Entre com o novo horario");
			word = sc.nextLine();
			return word;
		case 7:
			System.out.println("Entre com o novo dia da reuniao");
			word = sc.nextLine();
			return word;
		case 8:
			System.out.println("Entre com o novo mes");
			word = sc.nextLine();
			return word;
		}
	...
	public static void ChangeCraftAdress(Scanner sc) {
		System.out.println("Insira o novo nome da Loja Patrocinadora:");
		String sponshorshopName = sc.nextLine();
		;
		System.out.println("Insira o Numero da Loja Patrocinadora:");
		int SponshorShopNumber = sc.nextInt();
		sc.nextLine();
		System.out.println("Insira o Endereço no formato (Rua, Bairro).");
		String SponsorShopAdress = sc.nextLine();
		Loader.WriteCraftAdress(SponsorShopAdress, sponshorshopName, SponshorShopNumber);
	}
	...
	public static void CraftToLodgePerm(Scanner sc, PlaceType pT) {
		...
		case 'n':
			...
			int toPlaceNumber = CraftMenu.toPNumber(sc);
			sc.nextLine();
